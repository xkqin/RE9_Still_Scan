...
![FreeCam Dataset Capture Toolkit hero](docs/assets/hero.jpg)
...
[![Low-to-high trajectory replay demo](docs/assets/trajectory-demo-small.gif)](docs/assets/trajectory-demo.mp4)
...
![Capture pipeline](docs/assets/pipeline.jpg)

## Dataset Preview

![Dataset preview](docs/assets/dataset-preview.jpg)
...
![README layout reference](docs/assets/readme-style-reference.jpg)
