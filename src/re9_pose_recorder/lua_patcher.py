...
def build_lua_block(config: AppConfig, newline: str = "\n") -> str:
    ...
    lines = [
        ...
        "    local suspect = near_zero_dirs >= 2 or (min_probe_distance ~= nil and min_probe_distance <= 0.12)",
        ...
        "        re9_pose_logger.physics_probe_error = \"near_zero_dirs=\" .. tostring(near_zero_dirs) .. \" min_distance=\" .. tostring(min_probe_distance or \"?\") .. \" inside_contacts=\" .. tostring(inside_contacts)",
        "    elseif min_probe_distance ~= nil and min_probe_distance < 0.18 then",
        "        re9_pose_logger.physics_probe_status = \"near_surface\"",
        "        re9_pose_logger.physics_probe_error = \"min_distance=\" .. tostring(min_probe_distance) .. \" inside_contacts=\" .. tostring(inside_contacts)",
        "    else",
