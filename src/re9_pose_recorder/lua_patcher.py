...
def build_lua_block(config: AppConfig, newline: str = "\n") -> str:
    ...
    lines = [
        ...
        "        table.insert(detail_parts, string.format(\"%s i=%s d=%s\", label, tostring(count_i or \"?\"), best_dist ~= nil and string.format(\"%.4f\", best_dist) or \"?\"))",
        "    end",
        "    re9_pose_logger.physics_probe_contacts = inside_contacts",
