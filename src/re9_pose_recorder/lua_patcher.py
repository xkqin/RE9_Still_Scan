...
def build_lua_block(config: AppConfig, newline: str = "\n") -> str:
    ...
    lines = [
        ...
        "    re9_pose_logger.physics_probe_error = score > 0 and \"Camera collision system reports active collision/avoidance.\" or \"No live camera collision response found; singleton lookup may not expose scene camera objects.\"",
