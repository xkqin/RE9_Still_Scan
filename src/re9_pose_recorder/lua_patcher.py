...
def build_lua_block(config: AppConfig, newline: str = "\n") -> str:
    ...
    lines = [
        ...
        "end",
        "",
        "local function re9_pose_run_resolve_penetration(center, radius)",
        ...
        "    local ok_penetration, penetration_msg, sphere_penetrating = re9_pose_run_resolve_penetration(origin, sphere_radius)",
        ...
        "        local ok_p, msg_p, hit_p = re9_pose_run_resolve_penetration(origin, radius)",
        "        if ok_p then",
        ...
        "        re9_pose_logger.physics_probe_status = \"probe_saturated\"",
