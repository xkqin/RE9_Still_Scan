...
def build_lua_block(config: AppConfig, newline: str = "\n") -> str:
    ...
    lines = [
        ...
        "    local suspect = inside_contacts >= 4 or near_zero_dirs >= 3",
        ...
        "        re9_pose_logger.physics_probe_error = \"inside_contacts=\" .. tostring(inside_contacts) .. \" near_zero_dirs=\" .. tostring(near_zero_dirs)",
        "    else",
